...
const MAP_LIBS: Array<"places" | "geocoding" | "geometry"> = ["geometry"]; // Only geometry needed for distance if desired
...
const RiderTrackingMapClient: React.FC<RiderTrackingMapClientProps> = ({
  ...
  }, [riderId, isLoaded]); // Re-run if riderId changes
    ...
    >
      ...
      {riderLocation && (
        <Marker
          ...
          icon={{
            url: "http://maps.google.com/mapfiles/ms/icons/motorcycling.png", // A motorcycling icon for rider
            scaledSize: new window.google.maps.Size(40, 40),
          }}
