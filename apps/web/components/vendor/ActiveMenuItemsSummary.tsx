...
export default function ActiveMenuItemsSummary({
  vendorId,
}: ActiveMenuItemsSummaryProps) {
    ...
    <div className="rounded-2xl bg-white/10 p-6 backdrop-blur border border-white/50 shadow-md flex-1">
      ...
      {isLoading ? (
        <div className="flex w-full justify-center items-center h-20">
          ...
          <p className="ml-2 text-gray-500 text-sm">Loading count...</p>
        </div>
      ) : error ? (
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative w-16 h-16 flex-shrink-0 rounded-md overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center text-xl font-bold text-black z-10">
