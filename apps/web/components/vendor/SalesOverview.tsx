...
export default function SalesOverview({ vendorId }: SalesOverviewProps) {
  ...
  return (
    <div className="rounded-2xl bg-white/10 p-6 backdrop-blur border border-white/50 shadow-md flex-1 min-h-[400px]">
      {" "}
      {/* Add min-height */}
      <h2 className="text-black font-semibold text-lg mb-4">Sales Overview</h2>
      {isLoading ? (
        ...
        <>
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Total Sales (Last 30 Days)</p>{" "}
            {/* Adjust timeframe label */}
          </div>
