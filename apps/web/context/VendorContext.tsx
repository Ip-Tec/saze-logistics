...
const SUPABASE_STORAGE_BUCKET = process.env.NEXT_PUBLIC_SUPABASE_STORAGE_BUCKET as string;
// Provider component
...
          setVendorProfile(null);
          setCategories([]);
          // Do not return here, continue to check role if data exists partially
        } else {
...
          setFetchError(new Error("Access denied: User is not a vendor or profile not found."));
...
     try {
        console.log("Attempting to update profile for vendor:", vendorId, "with data:", updates);
...
            // toast.success("Profile updated successfully!"); // Toast moved to component
...
              // Assuming the public URL is like [supabase_url]/storage/v1/object/public/[bucket_name]/[path_in_bucket]
                 ...
                 const pathParts = img.image_url.split(`/${SUPABASE_STORAGE_BUCKET}/`); // Use the bucket name constant
...
          // Use a unique identifier for the file path within the item's directory
